...
var vm = new Vue({
    ...
    methods: {
        ...
        xuan2() {
            ...
            for (var i = 0; i < this.shang3.length; i++) {
                nian = this.shang3[i].h.substring(0, 4);
                yue = this.shang3[i].h.substring(4, 6);
                ri = this.shang3[i].h.substring(6, 8);
                shi = this.shang3[i].h.substring(8, 10);
                fen = this.shang3[i].h.substring(10, 12);
                miao = this.shang3[i].h.substring(12, 14);
                this.shang3[i].h = nian + '年' + yue + '月' + ri + '日' + ' ' + shi + ':' + fen + ':' + miao;
            }
    ...
    mounted() {
        if (this.jifen.length > 4) {
            this.jifens = '1';
        }
        console.log(this.jifens)
    },
})
//                                     LAYUI
